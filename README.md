...
[![CI](https://github.com/gridlhq-staging/yeager/actions/workflows/test.yml/badge.svg)](https://github.com/gridlhq-staging/yeager/actions/workflows/test.yml)
[![Release](https://github.com/gridlhq-staging/yeager/actions/workflows/release.yml/badge.svg)](https://github.com/gridlhq-staging/yeager/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Status: Beta](https://img.shields.io/badge/Status-Beta-orange)](https://github.com/gridlhq-staging/yeager)
...
```bash
curl -fsSL https://staging.yeager.sh/install | sh
yg pytest
```
